...
def copy_std_bvh(data_path, character, files):
    ...
    """
    cmd = 'cp \"{}\" ./dataset/Mixamo/std_bvhs/{}.bvh'.format(data_path + character + '/' + files[0], character)
    os.system(cmd)


if __name__ == '__main__':
    prefix = './dataset/Mixamo/'
    ...
    for character in characters:
        ...
        write_statistics(character, './dataset/Mixamo/mean_var/')
