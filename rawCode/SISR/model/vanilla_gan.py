...
import model.skeleton as skeleton
from model.skeleton import SkeletonConv, SkeletonUnpool, SkeletonPool
...
class Discriminator(nn.Module):
    def __init__(self, args, topology):
        ...
        for i in range(args.num_layers):
            ...
            # (args.num_layers-1)个【卷积层-BN-池化层-激活函数】的网络 & 1个【卷积层-池化层】的网络
