...
from GGIP.datasets import ImuMotionData
...
def main():
    ...
    # model = GAN_model_GIP(args, dataset, log_path='GGIP/logs/gaip_uniformM')
    model = GAN_model_GIP(args, dataset, log_path='GGIP/logs/transpose')
    # if args.epoch_begin:
    ...
    # args.epoch_begin = 201
    # model.load(epoch=40, suffix='GGIP/checkpoints/transpose')
    ...
    for epoch in range(args.epoch_begin, args.epoch_num):
        model.models.pose_encoder.train()
        model.models.auto_encoder.train() 
        ...
        #     model.save('GGIP/checkpoints/gaip_uniformM')
            # model.save('GGIP/checkpoints/transpose')
