...
class ImuMotionData(Dataset):
    def __init__(self, args, std_path=None):
        ...
        if args.is_train:
            # pose_gan_ref_path = ['GGIP/data_all/AMASS/Smpl_amass_motion_SMPL24.npy']
            # pose_gan_ref_data = []
            ...
            imu_path = ['GGIP/data_all/AMASS/Smpl_amass_imus.npy', 'GGIP/data_all/DIP_IMU/Smpl_dipTrain_imus.npy', 'GGIP/data_all/SingleOne-IMU/Smpl_singleone_imus.npy']
            joint_path = ['GGIP/data_all/AMASS/Smpl_amass_joints23.npy', 'GGIP/data_all/DIP_IMU/Smpl_dipTrain_joints23.npy', 'GGIP/data_all/SingleOne-IMU/Smpl_singleone_joints23.npy']   # 换成joints_pos专门训练一下第三阶段网络
            pose_path = ['GGIP/data_all/AMASS/Smpl_amass_motion_SMPL24.npy', 'GGIP/data_all/DIP_IMU/Smpl_dipTrain_motion_SMPL24.npy', 'GGIP/data_all/SingleOne-IMU/Smpl_singleone_motion_SMPL24.npy']
            # imu_path = ['GGIP/data_all/SingleOne-IMU/Smpl_singleone_imus.npy']
            # joint_path = ['GGIP/data_all/SingleOne-IMU/Smpl_singleone_joints23.npy']   # 换成joints_pos专门训练一下第三阶段网络
            # pose_path = ['GGIP/data_all/SingleOne-IMU/Smpl_singleone_motion_SMPL24.npy']
        else:
            # dip
