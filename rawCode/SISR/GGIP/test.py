...
def main():
    ...
    # model.load(epoch=0, suffix='GGIP/checkpoints/trial7_e2e_dipFinetune')
    # model.load(epoch=40, suffix='GGIP/checkpoints/gaip')  # GAIP的好结果
    model.load(epoch=60, suffix='GGIP/checkpoints/transpose')
