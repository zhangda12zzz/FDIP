...
import torch
import numpy as np
from utils_r.Quaternions import Quaternions
from utils_r.BVH_FILE import read_bvh, save_bvh
from utils_r.FKinematics import ForwardKinematics
from model_r.skeleton import build_bone_topology
...
big_vegas_skeleton = ['Pelvis', 'LeftUpLeg', 'LeftLeg', 'LeftFoot', 'LeftToeBase', 'RightUpLeg', 'RightLeg', 'RightFoot',
                      ...
                      'LeftForeArm', 'LeftHand', 'RightShoulder', 'RightArm', 'RightForeArm', 'RightHand']  # 23

aj_skeleton = ['Pelvis', 'LeftUpLeg', 'LeftLeg', 'LeftFoot', 'LeftToeBase', 'RightUpLeg', 'RightLeg', 'RightFoot',
               'RightToeBase', 'Hips', 'Spine', 'Spine1', 'Spine2', 'Neck', 'Head', 'LeftShoulder', 'LeftArm',
               'LeftForeArm', 'LeftHand', 'RightShoulder', 'RightArm', 'RightForeArm', 'RightHand'] # 23

smpl_skeleton = ['m_avg_Pelvis', 
                 ...
                 'm_avg_R_Collar', 'm_avg_R_Shoulder', 'm_avg_R_Elbow', 'm_avg_R_Wrist', 'm_avg_R_Hand']    # 24

# pn_skeleton_all = ['Robot_Hips', 'Robot_Spine', 'Robot_Spine1', 'Robot_Spine2', 'Robot_Spine3',
#                'Robot_Neck', 'Robot_Head', 'Robot_Head_End',
#                'Robot_LeftShoulder', 'Robot_LeftArm', 'Robot_LeftForeArm', 'Robot_LeftHand', 
#                 'Robot_LeftHandThumb1','Robot_LeftHandThumb2','Robot_LeftHandThumb3','Robot_LeftHandThumb4','Robot_LeftInHandIndex','Robot_LeftInHandIndex1','Robot_LeftInHandIndex2','Robot_LeftInHandIndex3','Robot_LeftInHandIndex4','Robot_LeftInHandMiddle','Robot_LeftInHandMiddle1','Robot_LeftInHandMiddle2','Robot_LeftInHandMiddle3','Robot_LeftInHandMiddle4','Robot_LeftInHandRing','Robot_LeftInHandRing1','Robot_LeftInHandRing2','Robot_LeftInHandRing3','Robot_LeftInHandRing4','Robot_LeftInHandPinky','Robot_LeftInHandPinky1','Robot_LeftInHandPinky2','Robot_LeftInHandPinky3','Robot_LeftInHandPinky4',
#                'Robot_RightShoulder', 'Robot_RightArm', 'Robot_RightForeArm', 'Robot_RightHand', 
#                 'Robot_RightHandThumb1','Robot_RightHandThumb2','Robot_RightHandThumb3','Robot_RightHandThumb4','Robot_RightInHandIndex','Robot_RightInHandIndex1','Robot_RightInHandIndex2','Robot_RightInHandIndex3','Robot_RightInHandIndex4','Robot_RightInHandMiddle','Robot_RightInHandMiddle1','Robot_RightInHandMiddle2','Robot_RightInHandMiddle3','Robot_RightInHandMiddle4','Robot_RightInHandRing','Robot_RightInHandRing1','Robot_RightInHandRing2','Robot_RightInHandRing3','Robot_RightInHandRing4','Robot_RightInHandPinky','Robot_RightInHandPinky1','Robot_RightInHandPinky2','Robot_RightInHandPinky3','Robot_RightInHandPinky4',
#                'Robot_LeftUpLeg', 'Robot_LeftLeg', 'Robot_LeftFoot', 'Robot_LeftToeBase',
#                'Robot_RightUpLeg', 'Robot_RightLeg', 'Robot_RightFoot', 'Robot_RightToeBase']   # 72
pn3_skeleton = ['Hips', 
...
simple_skeletons = [smpl_skeleton, pn3_skeleton]
ee_names = [ee_name_smpl, ee_name_pn3]


def get_bvh(character_name, bvh_file_name):
    bvh_path = './datasets/mixamo_work/{}/{}.bvh'.format(character_name, bvh_file_name)
    return bvh_path
...
class BvhData(object):
    def __init__(self, character_name, motion_file_name, args=None):
        ...
        # 由于smpl模型比较特殊，它的臀关节有很大位移、但在T-pose中又没有归0
        # 所以需要手动将smpl模型的臀关节Pelvis的offset数据和根关节root的offset数据交换
