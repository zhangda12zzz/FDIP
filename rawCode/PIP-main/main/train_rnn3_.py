...
if __name__ == '__main__':
    ...
    # writer = SummaryWriter('runs/trial4/rnn3_PIP')
    
    # 预训练的设置
    # pretrain_path = 'checkpoints/trial0129/rnn3/best__99_epoch_0.6611715545177459_batch.pkl'  # amasstrial中的final     11.0607 评价：虽然训练loss没上面低，但是验证loss相似
    ...
    for epoch in range(epochs):
        ...
        # writer.add_scalar('rnn3_mse/train', avg_train_loss, epoch)
        ...
        with torch.no_grad():
            ...
            # writer.add_scalar('rnn3_mse/val', avg_val_loss, epoch)
            ...
            if avg_val_loss < val_best_loss:
                ...
                if epoch > 0:
                    path_checkpoint = "./checkpoints/trial0129/rnn3/best__{}_epoch_{}_batch.pkl".format(epoch+pretrain_epoch, avg_val_loss)
        ...
        if epoch % checkpoint_interval == 0:
            checkpoint = {"model_state_dict": rnn3.state_dict(),
                    "optimizer_state_dict": optimizer.state_dict(),
                    "epoch": epoch+pretrain_epoch}
            path_checkpoint = "./checkpoints/trial0129/rnn3/checkpoints__{}_epoch_{}_batch.pkl".format(epoch+pretrain_epoch, avg_val_loss)
            torch.save(checkpoint, path_checkpoint)
            
    # checkpoint = {"model_state_dict": rnn3.state_dict(),
    #                   "optimizer_state_dict": optimizer.state_dict(),
    #                   "epoch": epochs+pretrain_epoch-1}
    # path_checkpoint = "./checkpoints/trial0129/rnn3/checkpoints__{}_epoch_{}.pkl".format(epochs+pretrain_epoch-1, avg_val_loss)
    # torch.save(checkpoint, path_checkpoint)