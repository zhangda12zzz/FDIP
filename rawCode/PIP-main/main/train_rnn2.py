...
if __name__ == '__main__':
    ...
    # 预训练的设置
    # pretrain_path = 'checkpoints/trial0129/rnn2/rnn2__checkpoint_final_34_epoch_0.014826596714556217.pkl'  # amasstrial中的final     11.0607 评价：虽然训练loss没上面低，但是验证loss相似
    ...
    for epoch in range(epochs):
        for batch_idx, data in enumerate(train_loader):
            ...
            target = list(p_all.view(-1, p_all.shape[1], 69))          # [max_seq, 69]
        ...
        with torch.no_grad():
            for batch_idx_val, data_val in enumerate(val_loader):
                ...
                target_val = list(p_all_val.view(-1, p_all_val.shape[1], 69))               # [max_seq, 69]                 
