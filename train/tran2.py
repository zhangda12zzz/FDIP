...
def evaluate_pipeline(model1, model2, model3, data_loader):
    ...
    with torch.no_grad():
        for data_val in data_loader:
            ...
            # Step 2: All joint prediction with AGGRU_2
            ...
            # Step 3: Joint rotation prediction with AGGRU_3
...
def main():
    ...
    # Perform end-to-end evaluation on the validation set
